...
import { FaGoogle, FaFacebook, FaItunes, FaBan } from "react-icons/fa";
...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(" 🚫 Login failed: Either your password or email is incorrect ");
    }
  };
      ...
      <div className="text-center text-4xl bg-[#FF5757] w-full h-[40rem] text-white p-12">
        ...
        >
          ...
          <div>
            <button
              type="submit"
              className="flex justify-center m-auto mt-6 bg-[#F13C3C] p-3 rounded-md shadow-sm shadow-black hover:bg-[#fc2e2e] border-[#444444] border-2 w-2/4 "
            >
              Login
            </button>
          </div>
